...
func NewCmdRegister(parentCommand string) *cobra.Command {
	...
	flags.StringVar(&opts.KarmadaAgentImage, "karmada-agent-image", fmt.Sprintf("registry.cn-hangzhou.aliyuncs.com/acejilam/karmada-agent:%s", releaseVer.ReleaseVersion()), "Karmada agent image.")
